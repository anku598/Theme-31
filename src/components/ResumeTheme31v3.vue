      ...
      <v-row class="freelancerCard">
        <v-col lg="12" md="12" cols="12" class="resumeCardRight">
          <v-row>
            ...
            >
              <div class="social-wrap custom-margin content-hide pr-7 version-3-social-wrap">
            ...
            <v-col lg="5" cols="12" sm="12" md="4" class="hire-sectionv3">
...
.profile-bg-card {
  ...
  @media screen and (max-width: 575.98px) {
    border-radius: 5px 5px 120px 5px !important;
  }
}
.hold_theme31 {
  max-width: 1920px;
